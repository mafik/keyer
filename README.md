...
The `src/` directory contains a prototype code for a wearable SSH Terminal that connects and displays its output through connected smart glasses.

The SSH code is not particularly polished so don't expect it to work out of the box.
